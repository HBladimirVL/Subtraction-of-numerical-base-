...
int resta_Base(int base,int e);

int a[50],n16b[50],c,aux_A[50],aux_F[50],aux_n16b[50],opcion,base,e;
...
int main(int argc, char** argv) {
	...
	printf("      restar ingrese cifra a cifra de un numero.\n\n");
	...
	printf("      cifra 4: 4\n");
	printf("      cifra 5: 5\n\n");
	printf("      Y asi debera hacer con el siguiente numero que se restara\n\n");
	...
	printf("      -------------------------------------------------------------\n");
	printf("                      BIENVENIDO A RESTA DE BASES\n");
	printf("      -------------------------------------------------------------\n");
	...
	switch(opcion) {
		...
		printf("                         RESTA BASE %d\n",base);
		printf("      -------------------------------------------------------------\n");
		printf("      CUANTOS NUMEROS RESTARA  2 O 3? ");
		scanf("%d",&e);printf("\n");system("cls");resta_Base(base,e);break;
		case 2:base=3;
		printf("      -------------------------------------------------------------\n");
		printf("                         RESTA  BASE %d\n",base);
		printf("      -------------------------------------------------------------\n");
...
int resta_Base(int base, int e){
	...
	if(w >= 11){
		...
		for(int i=0;i<iter;i++){
			if(resta==0){
				resta = (resta - totalFinal[i])*-1;
			}else{
				resta = resta - totalFinal[i];
			}
        }
		//DIVIDIR---------------------------------------------------------------------//
		int cociente,residuo[50],dividendo;char auxRe2[50];
        int divisor=w;int p=0;
        printf("      -------------------------------------------------------------\n");
	    printf("      SU RESTA EN BASE %d ES: ",w);
     	dividendo = resta;
	...
	//---------------------------------------------------------------------------//
	int cociente,residuo[50],auxRe[50],divisor=w,dividendo,p=0;
    printf("      -------------------------------------------------------------\n");
	printf("      SU RESTA EN BASE %d ES: ",w);
	dividendo = resta;
